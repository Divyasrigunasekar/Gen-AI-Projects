...
def run_react_agent(question: str, max_steps: int = 3) -> str:
    """Execute the ReAct loop until a final answer is returned or max_steps is reached."""
    history: List[str] = []
    ...
    for step in range(1, max_steps + 1):
        ...
        try:
            ...
            return "Error: failed to get a response from Groq."
    ...
    return (
        "The agent could not produce a final answer within the allowed steps. "
        "Please try again with a simpler query."
    )


if __name__ == "__main__":
    sample_question = "What is the projected global population in 2030?"
    print("Running ReAct agent for sample question...\n")
    final_answer = run_react_agent(sample_question)
    print("Final Answer:\n", final_answer)
